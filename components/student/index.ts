// Student list page components
export { StudentPageHeader } from "./student-page-header";
...
export { StudentDetailCard } from "./student-detail-card";
export { StudentDetailInfo } from "./student-detail-info";
export { StudentRelatedItems } from "./student-related-items";
