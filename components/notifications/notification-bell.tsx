...
> = {
  EXPENSE_SUBMITTED: { icon: DollarSign, color: "text-primary", bgColor: "bg-primary/10" },
  EXPENSE_APPROVED: { icon: CheckCircle, color: "text-emerald-600", bgColor: "bg-emerald-50" },
  EXPENSE_REJECTED: { icon: XCircle, color: "text-red-600", bgColor: "bg-red-50" },
  PROGRESS_UPDATE_SUBMITTED: { icon: BarChart3, color: "text-primary", bgColor: "bg-primary/10" },
  PROGRESS_UPDATE_REMINDER: { icon: Clock, color: "text-amber-600", bgColor: "bg-amber-50" },
  BUDGET_THRESHOLD_WARNING: { icon: AlertTriangle, color: "text-amber-600", bgColor: "bg-amber-50" },
  BUDGET_EXCEEDED: { icon: AlertOctagon, color: "text-red-600", bgColor: "bg-red-50" },
  STARTUP_ASSIGNED: { icon: Rocket, color: "text-primary", bgColor: "bg-primary/10" },
  STARTUP_STATUS_CHANGED: { icon: RefreshCw, color: "text-primary", bgColor: "bg-primary/10" },
  ...
  INCUBATION_ENDING_SOON: { icon: Calendar, color: "text-amber-600", bgColor: "bg-amber-50" },
