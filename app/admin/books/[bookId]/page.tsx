...
import { ArrowLeft, Edit, Trash2, Download, Eye, Star, FileText, BookOpen, User, School, Calendar } from "lucide-react";
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-3 flex-wrap">
              <h1 className="text-2xl font-bold text-ops-primary">{book.title}</h1>
            ...
            {book.description && (
              <p className="mt-3 text-sm text-ops-tertiary">{book.description}</p>
            )}
          </div>
