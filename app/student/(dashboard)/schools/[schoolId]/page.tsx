              ...
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  {school.classementNational && (
                    <div className="text-center p-4 rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
            ...
            <StudentDetailCard title="Partenariats">
              <div className="flex flex-wrap gap-2">
                {school.partenariats.map((partner) => (
                  <span
                    key={partner}
                    className="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 border border-purple-200 dark:border-purple-800"
                  >
                    {partner}
                  </span>
                ))}
        ...
        <div className="space-y-6">
          ...
          <Card className="ops-card border border-ops">
            ...
            <CardContent className="space-y-4">
              ...
              {school.bourses && (
                <div className="flex items-center gap-2 py-2 px-3 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
